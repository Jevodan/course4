...
import ru.geekbrains.gb_android_libraries.mvp.model.repo.MainUsersRepo;
...
import ru.geekbrains.gb_android_libraries.ui.PaperImpl;
import ru.geekbrains.gb_android_libraries.ui.RealmImpl;
import ru.geekbrains.gb_android_libraries.ui.RoomImpl;
...
public class MainPresenter extends MvpPresenter<MainView> {
    ...
    private MainUsersRepo usersRepo;
    private Scheduler mainThreadScheduler;
    private RepositoryListPresenter repositoryListPresenter;

    public MainPresenter(Scheduler mainThreadScheduler) {
        this.usersRepo = new MainUsersRepo(new RealmImpl());
